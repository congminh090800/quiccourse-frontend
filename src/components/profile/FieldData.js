      ...
      <div
        ...
        {props.field === 'PHOTO' ?
          <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '50%' }}>
            <Avatar style={{ height: 60, width: 60 }} alt={props.name} src={props.avatar ? imageUrlFormatter(props.avatar) : "not-exist"} />
          ...
          <IconButton onClick={handleOnClickExpand} >
            {props.field && props.field !== 'EMAIL' && (isExpanded ? <KeyboardArrowDownIcon /> : <ArrowForwardIosIcon />)}
          </IconButton>
        }
      </div >
      {isExpanded &&
        <div style={{ display: 'flex' }}>
          ...
          >
            ...
            <TextField width='150px'
              ...
              variant="outlined" default={props.content} />}
          <Button variant="filled" label={props.field} disableElevation onClick={handleOnClickDiscard}>
            Discard
          </Button>
        </div>
      }
