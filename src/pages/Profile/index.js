    ...
    <div className="profile">
      ...
      <Formik
        ...
        onSubmit={async (values) => {
          setIsLoading(true);
          const result = await httpAuthorization.put(
            endpoints.updateInformation,
            values
          );
          ...
          <form onSubmit={formik.handleSubmit}>
            <div className="profile-content">
              <div className="profile-content-header">
                ...
                <h3 style={{ fontWeight: 300, color: "#5f6368" }}>
              ...
              <div className="profile-content-body">
                <Card
                  ...
                  variant="outlined"
                  className="profile-content-body-card"
                >
                  <CardContent style={{ padding: "16px 0px" }}>
                    ...
                    <FieldData
                      ...
                      handler={handleOpenSetStudentIdDialog}
                    />
                    <FieldData
                      field="PHOTO"
                      ...
                      avatar={user.avatar}
                      name={user.name}
                      handler={handleOpenChangeAvatarDialog}
                    />
                    <FieldData
                      formik={formik}
                      fieldName="name"
            ...
            <ChangeAvatarDialog
              open={showChangeAvatarDialog}
              onClose={handleChangeAvatarDialogClose}
              user={user}
              setMessage={setMessage}
            />
            <SetStudentIdDialog
              open={showSetStudentIdDialog}
              onClose={handleCloseSetStudentIdDialog}
              setMessage={setMessage}
            />
            {formik.isValid && (
              <LoadingButton
